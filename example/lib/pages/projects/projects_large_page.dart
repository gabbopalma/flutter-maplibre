...
@immutable
class ProjectsLargePage extends StatefulWidget {
  const ProjectsLargePage({super.key});

  static const location = '/projects/large';

  @override
  State<ProjectsLargePage> createState() => _ProjectsLargePageState();
}

class _ProjectsLargePageState extends State<ProjectsLargePage> {
  final _points = <Point>[
