...
@immutable
class ProjectsExtralargePage extends StatefulWidget {
  const ProjectsExtralargePage({super.key});

  static const location = '/projects/extralarge';

  @override
  State<ProjectsExtralargePage> createState() => _ProjectsExtralargePageState();
}

class _ProjectsExtralargePageState extends State<ProjectsExtralargePage> {
  final _points = <Point>[
